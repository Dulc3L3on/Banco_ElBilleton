...
<html>
    ...
    <body>
        <form method="POST" action="Creacion_Cuentas"><!--si todo salió bien, entonces se refireccionará al servlet-->
            <center>
                <div id="general"><!--posiblemente lleve color xD o borde... o ambos xD-->
                    ...
                    <table cellspacing="10px" cellpadding="5px">                                        
                        ...
                        <tr>                            
                            ...
                            <th>
                                <input type="submit" name="submit" id="submit" value="NUEVO CLIENTE">
                            </th>                       
                        </tr>                        
                    </table>                    
                     <hr>
                 ...
                 <table cellpadding="10px">
                    ...
                    <tr>
                        ...
                        <th>
                            <select name="tipoDeCuenta"  id="tipoCuenta" required>
