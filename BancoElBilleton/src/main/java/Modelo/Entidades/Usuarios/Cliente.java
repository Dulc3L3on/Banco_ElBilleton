...
public class Cliente extends Usuario{
    ...
    public Cliente(int codigo, String nombre, String DPI, String elPath, String direccion, 
            String sexo, String password, String theBirth){//prueba si se pueden hacer las op para fecha en mysql con strings [varchars]...
