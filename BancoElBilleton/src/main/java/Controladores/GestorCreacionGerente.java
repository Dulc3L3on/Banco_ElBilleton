 ...
 * @author phily
 */
@WebServlet("/gestorCreacionGerente")
public class GestorCreacionGerente extends HttpServlet{
    Creador creador = new Creador();    
    Gerente gerente;//iba a acrear la clase par atransportar los datos, de tal forma que fuera universoal, pero cliente, cajero y gerente, solo serían empleados para la sesión... y yo creo que eso no es correcto xD... además creo que tendría que codificar más xD...
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){                                                                           
        ...
        usuario = creador.crearGerente(request.getParameterValues("datosUsuario"));                
        if(usuario!=null){
            gerente = (Gerente) usuario;
            request.setAttribute("turno", gerente.darTipoTurno());
        }                                                         
