...
<html>
    ...
    <body> 
         <form method="POST" enctype="multipart/form-data" action="../../cargaDPI"><!--si todo salió bien, entonces se refireccionará al servlet-->
            <center>
                    ...
                    <table>                                          
                        ...
                        <tr>
                         ...
                         <tr>                            
                            ...
                            <th>
                                <input type="date" name="datosUsuario" id="birth" required><!--si quieres le mandas la fecha actual.... pero por ser "requerido" no hbará problemas de ausencia xD-->
                            </th>
                            <th>
                                <label><h5>DPI:</h5></label>
                            </th>
                            <th>
                                <input type="file" name="archDPI" id="dpi" accept=".pdf" required><!--si quieres le mandas la fecha actual.... pero por ser "requerido" no hbará problemas de ausencia xD-->
                            </th>
                        </tr>                      
                    </table>                                   
                    
                    <input type="submit" id="submit" name="submit" value="CREAR CLIENTE" width="200px"><!--todos los sumbit sin importar de qué entidad sean y qué sea lo que suban tendrán el mismo aspecto...-->                    
                </div>                
            </center>            
        </form>       
    </body>
