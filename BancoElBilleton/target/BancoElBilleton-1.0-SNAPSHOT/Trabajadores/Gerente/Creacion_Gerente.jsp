<%-- 
    Document   : Creacion_Gerente
    Created on : 15/11/2020, 21:09:56
    Author     : phily
--%>
...
<html>
    ...
    <body>
       <form method="POST" action="../../gestorCreacionGerente"><!--si todo salió bien, entonces se refireccionará al servlet-->
            <center>
                <div id="general"><!--posiblemente lleve color xD o borde... o ambos xD-->
                    <h1>>>CREAR GERENTE<<</h1>    
                    <br/>
                    <label style="position: relative; left:-250px;">>Datos del Nuevo Gerente</label>
                    <table>                                          
                        <tr>
                            <th colspan='4'>
                                <hr>
                    ...
                    <input type="submit" id="submit" name="submit" value="CREAR GERENTE" width="200px"><!--todos los sumbit sin importar de qué entidad sean y qué sea lo que suban tendrán el mismo aspecto...-->                    
                </div>               
            </center>
        </form>        
    </body>
